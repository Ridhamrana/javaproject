			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="active menu__item menu__item--current dropdown">
					   <a class="menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown">Registration<b class="caret"></b></a>
					...
					<li class="menu__item dropdown">
					   <a class="menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown">Login <b class="caret"></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Customer <span>Registration </span></h3>
			<!--/w3_short-->
	...
	<div class="container">
	   <div class="agile-contact-grids">
					<div class="col-md-12 contact-form">
						<h4 class="white-w3ls">Customer <span>Registration Form</span></h4>
						<form action="CustomerController" method="post" align="center" enctype="multipart/form-data">
							<div class="styled-input agile-styled-input-top">
