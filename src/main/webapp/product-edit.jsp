			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="menu__item"><a class="menu__link" href="seller-index.jsp">Home <span class="sr-only">(current)</span></a></li>
					<li class=" menu__item"><a class="menu__link" href="about.jsp">About</a></li>
					<li class="menu__item">
						<a class="menu__link" href="upload-product.jsp">Upload Product <span class=""></a>	
					</li>
					<li class="active menu__item menu__item--current"><a class="menu__link" href="manage-product.jsp">Manage Product</a></li>
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Product <span>Update</span></h3>
			<!--/w3_short-->
	...
	<div class="container">
	   <div class="agile-contact-grids">
					<div class="col-md-12 contact-form">
						<h4 class="white-w3ls">Product<span> Update Form</span></h4>
						...
						<input type="hidden" name="Sid" value="<%=p.getSid() %>">
							...
							<img alt="" src="product-img/<%=p.getImage() %>" height=100px width=100px>
								<span></span>
							</div>
							<div class="styled-input">
							...
							<div class="styled-input">
								<input type="text" name="MRP" value="<%=p.getMRP() %>" required="">
								<label>M.R.P.</label>
								<span></span>
							</div>
							<div class="styled-input">
								<input type="text" name="Services" value="<%=p.getServices() %>" required=""> 
								<label>Services</label>
								<span></span>
							</div> 
							<div class="styled-input">
								<input type="text" name="Details" value="<%=p.getDetails() %>" required="">
