			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li><a class="menu__link" href="seller-index.jsp">Home <span class="sr-only">(current)</span></a></li>
					<li class=" menu__item"><a class="menu__link" href="about.jsp">About</a></li>
					<li class="menu__item">
						<a class="menu__link" href="upload-product.jsp">Upload Product</a>	
					</li>
					<li class=" menu__item"><a class="menu__link" href="manage-product.jsp">Manage Product</a></li>
					<li class="active menu__item menu__item--current" class="menu__item dropdown">
					   <a class="menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown">
					   <%=s.getFirstName() %>&nbsp; &nbsp;<%=s.getLastName() %> 
						<div class="" style="display: inline-block; border-radius: 50%;">  <img src="customer-img/<%=s.getImage()%>" style="display: inline-block;" width=25px height=25px/> </div>
						<b class=""></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
									<li><a href="seller-profile.jsp">Profile</a></li>
									<li><a href="seller-registration.jsp">Logout</a></li>
								</ul>
					</li>
				  </ul>
				</div>
	...
	<div class="container">
	   <div class="agile-contact-grids">
					<div class="col-md-12 contact-form">
						<h4 class="white-w3ls">Seller <span>Profile</span></h4>
						<form action="SellerController" method="post" enctype="multipart/form-data">
							<div class="styled-input agile-styled-input-top">
								<input type="file" name="Image" required="">
								<img alt="" src="seller-img/<%=s.getImage() %>" height="100px" width="100px">
								<input type="submit" name="faction" value="Edit">
								<span></span>
							</div>
							<div class="styled-input">
								<div class="col-md-10">
								<input type="text" name="FirstName" value="<%=s.getFirstName() %>" required="">
								</div>
								<input type="submit" name="faction" value="Edit">
							...
							<div class="styled-input">
								<div class="col-md-10">
								<input type="text" name="LastName" value="<%=s.getLastName() %>" required="">
								</div>
								<input type="submit" name="laction" value="Edit">
								<label>Last Name</label>
								<span></span>
							</div>
							<div class="styled-input">
							<div class="col-md-10">
								<input type="text" name="MobileNumber" value="<%=s.getMobileNumber() %>" required="">
								</div>
							...
							<div class="col-md-10">
								...
								<input type="submit" name="eaction" value="Edit">
								<label>Email</label>
								<span></span>
							</div> 
							<div class="styled-input">
							<div class="col-md-10">
								...
								<input type="submit" name="paction" value="Edit">
