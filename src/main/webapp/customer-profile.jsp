			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class=""><a class="menu__link" href="customer-index.jsp">Home <span class="sr-only">(current)</span></a></li>
	...
	<div class="container">
	   <div class="agile-contact-grids">
					<div class="col-md-12 contact-form">
						<h4 class="white-w3ls">Customer <span>Profile</span></h4>
						<form action="CustomerController" method="post" enctype="multipart/form-data">
							<div class="styled-input agile-styled-input-top">
								<input type="file" name="Image" required="">
								<img alt="" src="customer-img/<%=c.getImage() %>" height="100px" width="100px">
							...
							<div class="styled-input">
							<div class="col-md-10">
								<input type="text" name="MobileNumber" value="<%=c.getMobileNumber() %>" required="">
								</div>
