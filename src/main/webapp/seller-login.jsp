...
<div class="page-head_agile_info_w3l">
	...
	<div class="container">
		<div class="col-md-12">
			<h3 class="text-center text-success">${smsg1 }</h3>
		</div>
   </div>
	...
	<div class="container">
	   <div class="agile-contact-grids">
					<div class="col-md-12 contact-form">
						<h4 class="white-w3ls">Seller <span>Login</span></h4>
						<h3 class="text-center text-danger">${smsg }</h3>
