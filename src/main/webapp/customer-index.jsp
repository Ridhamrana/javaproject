...
<%@page import="com.CustomerDao.CustomerDao"%>
<%@page import="com.CustomerModel.Customer"%>
...
if(session.getAttribute("msg")!=null){
	c=(Customer)session.getAttribute("msg");
}
else{
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="customer-index.jsp"><span>E</span>lite Shoppy <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
				  ...
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="menu__item dropdown">
					   ...
					   <%=c.getFirstName() %>&nbsp; &nbsp;<%=c.getLastName() %> 
						<div class="" style="display: inline-block; border-radius: 50%;">  <img src="customer-img/<%=c.getImage()%>" style="display: inline-block;" width=25px height=25px/> </div>
						<b class=""></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
									<li><a href="customer-profile.jsp">Profile</a></li>
									<li><a href="customer-registration.jsp">Logout</a></li>
								</ul>
					</li>
				  </ul>
				</div>
...
<!-- /new_arrivals -->
	<div class="new_arrivals_agile_w3ls_info">
		<div class="container">
			...
			<% List<Product> list = CustomerDao.getallProducts(); %>
			<%for(Product p :list){
				%>
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="product-img/<%=p.getImage() %>" alt="" class="pro-image-front" style="height: 200px; width: auto;">
									<img src="product-img/<%=p.getImage() %>" alt="" class="pro-image-back" style="height: 200px; width: auto;">
								...
								<div class="item-info-product ">
									...
									<div>
										<form action="CartController" method="post">
											<button class="text-white btn btn-lg hvr-outline-out button2" name="action" value = "Submit">Add to Cart</Button>
											<br>
											<br>
											<a href="product-buy.jsp?id=<%=p.getPid()%>" class="text-white btn btn-lg hvr-outline-out button2">Buy Now</a>
										</form>
									</div>
